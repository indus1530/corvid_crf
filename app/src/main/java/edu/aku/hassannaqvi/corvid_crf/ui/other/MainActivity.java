...
import edu.aku.hassannaqvi.corvid_crf.core.AndroidDatabaseManager;
    ...
    public static class MyDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setTitle("COVID Sukkur APP is available!")
                    .setCancelable(false)
                    .setMessage("COVID Sukkur App " + newVer + " is now available. Your are currently using older version " + preVer + ".\nInstall new version to use this app.")
